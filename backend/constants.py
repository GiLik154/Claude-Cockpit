...
USAGE_CLI_STARTUP_DELAY: float = 5.0
USAGE_CAPTURE_DELAY: float = 5.0
USAGE_FIRST_READY_DELAY: float = 8.0
USAGE_LOADING_RETRY_DELAY: float = 3.0
USAGE_LOADING_MAX_RETRIES: int = 5
